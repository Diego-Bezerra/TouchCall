 ...
 */
public class TouchCallWidgetProviderMedium extends TouchCallWidgetProvider {

    @Override
    public void onDisabled(Context context) {
        super.onDisabled(context);

        setHasAlreadyTouchCallFalse(context, Common.ProviderClass.MEDIUM.getClassName());
    }
}
